...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr
point_cloud_from_txt(std::string file_path)
{
  ...
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr temporal_point_cloud_ptr (new pcl::PointCloud<pcl::PointXYZRGB>);
  ...
  std::cout << temporal_point_cloud_ptr->points.size()<<" Points from file:"<<data<<std::endl;
...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr
point_cloud_open_file(std::string file_path)
{
...
open_test_files()
{
  ...
  //  file_path_vector.push_back("./data/P05S10.txt.pcd");
  //  file_path_vector.push_back("./data/P05S11.txt.pcd");
  //  file_path_vector.push_back("./data/P05S12.txt.pcd");
  // file_path_vector.push_back("./data/P05S13.txt.pcd");
