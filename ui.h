...
public:
  model cloud_model; 
private:
  int g_meank; float g_stddev ; 
  float g_bottom; float g_top; 
  float g_leaf_size; int g_max_icp; 
  float g_voxel_leaf; int g_seg_max_iter; int g_dist; 
  double g_cluter_tol; int g_min_clu; int g_max_clu; 
public:
  laserApp();
