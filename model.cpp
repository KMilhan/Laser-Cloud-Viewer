...
int model::registration()
{
	...
	// boost::shared_ptr<pcl::visualization::PCLVisualizer> rgbviewer;
	// rgbviewer = rgbVis(rgb_cloud);
	// while (!rgbviewer->wasStopped ())
	// {
 //      	//simpleViewer->spinOnce(100);
...
int model::segmentation(float voxel_leaf_size = 10.f, int max_iteration = 256, int distance_thresh = 200, double cluster_tolerance = 200.0, int min_cluster_size = 100, int max_cluster_size = 25000)
{
